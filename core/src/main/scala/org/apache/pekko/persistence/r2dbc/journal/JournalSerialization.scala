 ...
 * INTERNAL API
 *
 * Serialization of an [[AtomicWrite]] into [[SerializedJournalRow]] rows, used by the [[StreamBatchedWriteJournal]].
 * Mirrors the serialization done inline in [[R2dbcJournal]].
 */
